"""
GPU burn / keep-alive loop for SDXL Base daemon.

Start the daemon once, then run this script to repeatedly call it.
"""
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--prompt", type=str, default="An astronaut riding a green horse")
